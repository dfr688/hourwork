<template>
    <ul class="stack">
      <li class="stack-item"
      :style="[transformIndex(1),transform(1)]"
      @touchmove="touchmove"
      @touchstart="touchstart"
      @touchend="touchend"
      @touchcancel="touchend"
      @webkit-transition-end="onTransitionEnd(1)"
      @transitionend="onTransitionEnd(1)">
      ...
      <li class="stack-item"
      :style="[transformIndex(2),transform(2)]"
      @touchmove="touchmove"
      @touchstart="touchstart"
      @touchend="touchend"
      @touchcancel="touchend"
      @webkit-transition-end="onTransitionEnd(2)"
      @transitionend="onTransitionEnd(2)">
...
<script>
import detectPrefixes from '../../assets/js/detect-prefixes'
export default {
  props: {
    stackinit: {
      type: Object,
  ...
  data () {
    return {
      ...
      temporaryData: {
        ...
        rotate: 0,
        lastRotate: 0,
        visible: this.stackinit.visible || 2,
        tracking: false,
        animation: false,
        currentPage: this.stackinit.currentPage,
        opacity: 1,
        lastOpacity: 0,
        swipe: false,
        zIndex: 10
